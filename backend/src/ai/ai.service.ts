        ...
        try {
            ...
            const response = await this.openai.chat.completions.create({
                ...
                messages: [
                    {
                        role: "system",
                        content: "Sen bir dijital gardırop asistanısın. Gösterilen kıyafeti analiz et.\n1. KATEGORİ: Yalnızca şunlardan birini seç: 'Üst Giyim', 'Alt Giyim', 'Dış Giyim', 'Ayakkabı', 'Aksesuar'.\n2. RENKLER: YALNIZCA şu listeden seç: Siyah, Beyaz, Lacivert, Gri, Vizon, Bej, Camel, Kahverengi, Kırmızı, Bordo, Mavi, Yeşil, Sarı, Turuncu, Pembe, Mor.\n3. CİNSİYET — ÇOK ÖNEMLİ: Kıyafetin kesimini, modelini ve stilini analiz ederek şunlardan birini seç:\n   - 'Erkek': Erkek kesimi kıyafet (düz/chino/slim pantolon, erkek gömlek, polo, spor ayakkabı erkek modeli vb.)\n   - 'Kadın': Kadın kesimi kıyafet (bol/palazzo/flar pantolon, kadın bluzu, etek, elbise, crop top, kadın trençkotu vb.)\n   - 'Unisex': Gerçekten her iki cinsiyete uygun (düz basic tişört, klasik jean, spor sweatshirt vb.)\n   NOT: Camel/bej renk bol paçalı/akışkan pantolon → Kadın. Slim fit düz renk pantolon → Erkek.\nYanıtın kesinlikle JSON olmalı. Örn: {\"category\": \"Alt Giyim\", \"colors\": [\"Camel\"], \"gender\": \"Kadın\"}"
                    },
                    {
                        role: "user",
                        content: [
